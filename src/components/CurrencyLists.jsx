...
export default function CurrencyLists() {
  ...
  return (
    <div className="flex gap-10 my-10 rounded-lg">
      <Card fromValue={fromValue} fullName={fullName} toValue={toValue} toFullName={toFullName} />
      <Card reverse={true} fromValue={toValue} fullName={toFullName} toValue={fromValue} toFullName={fullName} />
    </div>
  );
}
